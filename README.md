...
| --- | --- |
| [![@bepower/auto-config: 10.0.1](https://img.shields.io/badge/@bepower/auto--config-10.0.1-brightgreen.svg)](packages/auto-config) | `$ npm install --save-dev @bepower/auto-config@10.0.1` |
