...
| [![@bepower/eslint-plugin: 4.6.0](https://img.shields.io/badge/@bepower/eslint--plugin-4.6.0-brightgreen.svg)](packages/eslint-plugin) | `$ npm install --save-dev @bepower/eslint-plugin@4.6.0` |
